...
export default function Index(props) {
  ...
  useEffect(() => {
    setCheckPath(window.location.pathname.indexOf('Lien-he'));
      ...
      <Container className="home">
        ...
        {checkPath === 1 ? (
          ...
          <div>
            ...
            <h1 id="result-stats">
              {total ? (
                <>Tìm được {getFormattedNumber(total)} kết quả &nbsp;</>
              ) : (
                      ...
                      <div className="link_info">
                        <div className="info">
                          <span>
                            <IconVisibility />
                            &nbsp;
                            <span style={{ verticalAlign: 'middle' }}>{item.ViewCount || 0}</span>
                          </span>
                          <span>
                            <IconShare />
                            &nbsp;
                            <span style={{ verticalAlign: 'middle' }}>{item.ShareCount || 0}</span>
                          </span>
                          <span>
                            <IconClick />
                            &nbsp;
                            <span style={{ verticalAlign: 'middle' }}>{item.ClickCount || 0}</span>
                          </span>
                          <span>
                            <IconInfo />
                            &nbsp;
                            <span style={{ verticalAlign: 'middle ' }}>{item.DataRating || 0}</span>
                          </span>
                          <span>
                            <IconStar />
                            &nbsp;
                            <span style={{ verticalAlign: 'middle' }}>{item.InvestmentRating || 0}</span>
                          </span>
