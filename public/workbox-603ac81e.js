define("./workbox-603ac81e.js",['exports'], function (exports) { 'use strict';
    ...
    */
    ...
    class NetworkOnly {
      ...
      async handle({
        ...
        {
          logger$1.groupCollapsed(messages$2.strategyStart('NetworkOnly', request));

          if (response) {
            logger$1.log(`Got response from network.`);
          } else {
            logger$1.log(`Unable to get a response from the network.`);
          }
...
//# sourceMappingURL=workbox-603ac81e.js.map
